...
public interface AvailableSettings {
	...
	/**
	 * Used as a query hint to specifiy entity graph.
	 *
	 * <p/>
	 * When the {@code javax.persistence.fetchgraph} property is used to specify an entity graph,
	 * attributes that are specified by attribute nodes of the entity graph are treated as
	 * FetchType.EAGER and attributes that are not specified are treated as FetchType.LAZY.
	 * <p/>
	 * See JPA 2.1 section 3.7.4.1
	 */
	 ...
	 *
	 * <p/>
	 * When the {@code javax.persistence.loadgraph} property is used to specify an entity graph,
	 * attributes that are specified by attribute nodes of the entity graph are treated
	 * as FetchType.EAGER and attributes that are not specified are treated according to
	 * their specified or default FetchType.
	 * <p/>
	 * See JPA 2.1 section 3.7.4.2
	 */
	String LOAD_GRAPH = "javax.persistence.loadgraph";
